# Generated by Django 5.0.2 on 2024-04-25 04:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='LectureRecord',
            fields=[
                ('lr_id', models.AutoField(default='1', primary_key=True, serialize=False)),
                ('course_number', models.CharField(max_length=50)),
                ('course_name', models.CharField(default='TBD', max_length=50)),
                ('instructer_id', models.CharField(max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fd_id', models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='authentication.lecturerecord')),
            ],
        ),
        migrations.AddField(
